class SankeyChart3 {
    ...
    updateVis() {
        ...
        vis.svg.selectAll("#Alaska")
            .style("stroke", "green")
            .style("stroke-opacity", 1)
            .attr("id", d => {
                document.getElementById("outcome-row4").innerHTML = d.outcome + "%";
                document.getElementById("income-row4").innerHTML = "$"+d3.format(",")(d.income);
        })

        vis.svg.selectAll("#Utah")
            .style("stroke", "yellow")
            .style("stroke-opacity", 1)
            .attr("id", d => {
                document.getElementById("outcome-row5").innerHTML = d.outcome + "%";
                document.getElementById("income-row5").innerHTML = "$"+d3.format(",")(d.income);
            })


        vis.svg.selectAll(".link")
            .on('mouseover', function(event, d) {
                if (d.class !== "Alaska" && d.class !== "Utah") {
